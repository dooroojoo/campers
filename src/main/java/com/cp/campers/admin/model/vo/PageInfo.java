...
public class PageInfo {
	...
	private int listCount;		// 전체 회원 수 (105)
	private int pageLimit;		// 하단에 보여질 페이지 목록 수 (10)
	private int userLimit;		// 한 페이지에 보여질 회원 최대 수 (10)
	...
	public PageInfo(int page, int listCount, int pageLimit, int userLimit) {
		...
		this.maxPage = (int)Math.ceil((double)listCount / userLimit);	// ceil : 올림 처리
	...
	public String toString() {
		return "PageInfo [page=" + page + ", listCount=" + listCount + ", pageLimit=" + pageLimit + ", userLimit="
				+ userLimit + ", maxPage=" + maxPage + ", startPage=" + startPage + ", endPage=" + endPage
